...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\fastuserswitching" /v "Start" /t REG_DWORD /d "4" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\wanarp" /v "Start" /t REG_DWORD /d "4" /f
...
REM ; System Locale
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Nls\CodePage" /v "ACP" /t REG_SZ /d "1252" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Nls\CodePage" /v "OEMCP" /t REG_SZ /d "437" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Nls\CodePage" /v "MACCP" /t REG_SZ /d "10000" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Nls\Language" /v "Default" /t REG_SZ /d "0409" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Conferencing" /v "NoRDS" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Cryptography\AutoEnrollment" /v "AEPolicy" /t REG_DWORD /d "7" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Cryptography\AutoEnrollment" /v "OfflineExpirationPercent" /t REG_DWORD /d "10" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Cryptography\AutoEnrollment" /v "OfflineExpirationStoreNames" /t REG_SZ /d "MY" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Cryptography\Configuration\SSL\00010002" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "excel.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "exprwd.exe" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "groove.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "msaccess.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "mse7.exe" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "mspub.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "onenote.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "outlook.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "powerpnt.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "pptview.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "spdesign.exe" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "visio.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "winproj.exe" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main\FeatureControl\feature_safe_bindtoobject" /v "winword.exe" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Safety\PrivacIE" /v "DisableTrackingProtection" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\SystemCertificates\CA\Certificates" /ve /t REG_SZ /d "" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\SystemCertificates\CA\CRLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\SystemCertificates\CA\CTLs" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Appx" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Cache" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /v "AllowTelemetry" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\DeviceRedirect\Restrictions" /v "AllowRedirect" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\EventLog\ProtectedEventLogging" /v "EnableProtectedEventLogging" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\EventLog\ProtectedEventLogging" /v "EncryptionCertificate" /t REG_MULTI_SZ /d "" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\EventLog\Security" /v "MaxSize" /t REG_DWORD /d "196608" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\EventLog\Setup" /v "Enabled" /t REG_SZ /d "1" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\NetworkConnectivityAssistant" /v "NamePreferenceAllowed" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\NetworkConnectivityAssistant" /v "ShowUI" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\NetworkConnectivityAssistant\Probes" /v "PING:myserver.corp.contoso.com" /t REG_SZ /d "PING:myserver.corp.contoso.com" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\NetworkConnectivityStatusIndicator" /ve /t REG_SZ /d "" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\NetworkProvider\HardenedPaths" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\PowerShell" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\System" /v "PrimaryComputerEnabledRUP" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WcmSvc\GroupPolicy" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\wdi\{c295fbba-fd47-46ac-8bee-b1715ec634e5}" /v "DownloadToolsEnabled" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WinRM\Client" /v "AllowCredSSP" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WinRM\Client" /v "AllowDigest" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WinRM\Client" /v "AllowKerberos" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WinRM\Client" /v "AllowNegotiate" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WinRM\service" /v "AllowCredSSP" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WinRM\service" /v "AllowKerberos" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WinRM\service" /v "AllowNegotiate" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WinRM\service" /v "HttpCompatibilityListener" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WinRM\service" /v "HttpsCompatibilityListener" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WSDAPI\Discovery Proxies" /ve /t REG_SZ /d "" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows Advanced Threat Protection" /ve /t REG_SZ /d "" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender" /v "PUAProtection" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender" /v "DisableAntiSpyware" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\MpEngine" /v "MpBafsExtendedTimeout" /t REG_DWORD /d "50" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\Policy Manager" /ve /t REG_SZ /d "" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\Real-Time Protection" /v "DisableRealtimeMonitoring" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\common\research\translation" /v "useonline" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\common\security\trusted locations" /v "allow user locations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\common\trustcenter" /v "trustbar" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\excel\security\trusted locations" /v "alllocationsdisabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\excel\security\trusted locations" /v "allownetworklocations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\infopath\editor\offline" /v "cachedmodestatus" /t REG_DWORD /d "2" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\infopath\security\trusted locations" /v "alllocationsdisabled" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\powerpoint\security\trusted locations" /v "alllocationsdisabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\powerpoint\security\trusted locations" /v "allownetworklocations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\wef\trustedcatalogs" /v "disableomexcatalogs" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\wef\trustedcatalogs" /v "requireserververification" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\word\security\trusted locations" /v "alllocationsdisabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\15.0\word\security\trusted locations" /v "allownetworklocations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\access\security" /v "vbawarnings" /t REG_DWORD /d "3" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\access\security\trusted locations" /v "allownetworklocations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\common\research\translation" /v "useonline" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\common\security\trusted locations" /v "allow user locations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\common\toolbars\project" /v "noextensibilitycustomizationfromdocument" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\common\toolbars\visio" /v "noextensibilitycustomizationfromdocument" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\common\trustcenter" /v "trustbar" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\excel\security" /v "excelbypassencryptedmacroscan" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\excel\security" /v "vbawarnings" /t REG_DWORD /d "3" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\excel\security" /v "webservicefunctionwarnings" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\excel\security\fileblock" /v "xl9597workbooksandtemplates" /t REG_DWORD /d "2" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\excel\security\fileblock" /v "xl95workbooks" /t REG_DWORD /d "2" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\excel\security\filevalidation" /v "openinprotectedview" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\excel\security\trusted locations" /v "alllocationsdisabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\excel\security\trusted locations" /v "allownetworklocations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\ms project\security" /v "vbawarnings" /t REG_DWORD /d "3" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\ms project\security\trusted locations" /v "allownetworklocations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\outlook\security" /v "fileextensionsremovelevel1" /t REG_SZ /d ";" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\outlook\security" /v "fileextensionsremovelevel2" /t REG_SZ /d ";" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security" /v "powerpointbypassencryptedmacroscan" /t REG_DWORD /d "0" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security" /v "requireaddinsig" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security" /v "runprograms" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security" /v "vbawarnings" /t REG_DWORD /d "3" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security\filevalidation" /v "openinprotectedview" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security\trusted locations" /v "alllocationsdisabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security\trusted locations" /v "allownetworklocations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\publisher\security" /v "vbawarnings" /t REG_DWORD /d "3" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\visio\security" /v "vbawarnings" /t REG_DWORD /d "3" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\visio\security\trusted locations" /v "allownetworklocations" /t REG_DWORD /d "0" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\wef\trustedcatalogs" /v "requireserververification" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security" /v "vbawarnings" /t REG_DWORD /d "3" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security" /v "wordbypassencryptedmacroscan" /t REG_DWORD /d "0" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security\fileblock" /v "openinprotectedview" /t REG_DWORD /d "0" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security\fileblock" /v "word2000files" /t REG_DWORD /d "2" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security\fileblock" /v "word95files" /t REG_DWORD /d "2" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security\fileblock" /v "word97files" /t REG_DWORD /d "2" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security\fileblock" /v "wordxpfiles" /t REG_DWORD /d "2" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security\filevalidation" /v "openinprotectedview" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security\trusted locations" /v "alllocationsdisabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\16.0\word\security\trusted locations" /v "allownetworklocations" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\common\security" /v "automationsecuritypublisher" /t REG_DWORD /d "2" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\office\common\security" /v "uficontrols" /t REG_DWORD /d "6" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\CA\Certificates" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\CA\CRLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\CA\CTLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\Disallowed\Certificates" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\Disallowed\CRLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\Disallowed\CTLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\trust\Certificates" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\trust\CRLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\trust\CTLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\TrustedPeople\Certificates" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\TrustedPeople\CRLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\TrustedPeople\CTLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\TrustedPublisher\Certificates" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\TrustedPublisher\CRLs" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\TrustedPublisher\CTLs" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\CloudContent" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\5.0\Cache" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Cache" /ve /t REG_SZ /d "" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /ve /t REG_SZ /d "" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\Explorer" /v "DisableNotificationCenter" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\Network Connections" /v "NC_DeleteAllUserConnection" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\Windows Error Reporting" /v "Disabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows NT\Driver Signing" /v "BehaviorOnFailedVerify" /t REG_DWORD /d "2" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows NT\printers\wizard" /v "Downlevel Browse" /t REG_DWORD /d "0" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows NT\SharedFolders" /v "PublishDfsRoots" /t REG_DWORD /d "0" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows NT\SharedFolders" /v "PublishSharedFolders" /t REG_DWORD /d "0" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services" /v "AllowSignedFiles" /t REG_DWORD /d "0" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services" /v "AllowUnsignedFiles" /t REG_DWORD /d "0" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services" /v "DisablePasswordSaving" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer" /v "PreventCodecDownload" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Power\PowerSettings" /ve /t REG_SZ /d "" /f
REM ; SysHardener
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\CA\Certificates" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\CA\CRLs" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\CA\CTLs" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\Disallowed\Certificates" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\Disallowed\CRLs" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\Disallowed\CTLs" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\trust\Certificates" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\trust\CRLs" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\trust\CTLs" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\TrustedPeople\Certificates" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\TrustedPeople\CRLs" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\SystemCertificates\TrustedPeople\CTLs" /f
...
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\Explorer" /v "DisableNotificationCenter" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Microsoft\Windows\Windows Error Reporting" /v "Disabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Policies\Power" /f
REM ; Ghost spectre machine policy
Reg.exe add "HKCU\SOFTWARE\Policies\Power\PowerSettings" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Biometrics" /v "Enabled" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Personalization" /v "NoLockScreen" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\PowerShell" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /v "EnableBackupForWin8Apps" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\System" /v "DisableAcrylicBackgroundOnLogon" /t REG_DWORD /d "1" /f
